...
class AccessoryTypeFormUI extends Component {
    ...
    _validate(fieldName, value) {
        ...
        switch (fieldName) {
            case 'name':
                ...
                fieldValidationErrors.name = nameValid ? '' : 'Vui lòng nhập tên loại linh kiện trong khoảng 6-100 ký tự!';
                break;
...
export default AccessoryTypeFormUI
