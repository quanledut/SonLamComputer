...
class DeviceTypeFormUI extends Component {
                                ...
                                <Form action="" method="post">
                                    <FormGroup>
                                        ...
                                        <Input onChange = {(event) => (this.isChange(event))} 
                                         ...
                                         {this.state.error.name ? <FormText className="help-block"><span style={{color: "red"}}>Vui lòng nhập tên loại thiết bị trong khoảng 6-100 ký tự!</span></FormText> : ''} 
                                    </FormGroup>
                                </Form>
                            </CardBody>
                            <CardFooter>
...
export default DeviceTypeFormUI
