    ...
    render(){
      return (
        <div className="trends">
            <div className="trends_background" style={{backgroundImage: `url(${require('../../../../stylesheets/images/trends_background.jpg')})`}} />
                    ...
                    <div className="owl-carousel owl-theme trends_slider">
                      ...
                      <div className="owl-item">
                        <div className="trends_item is_new">
                          <div className="trends_image d-flex flex-column align-items-center justify-content-center"><img src={require("../../../../stylesheets/images/trends_1.jpg" )}alt /></div>
                      ...
                      <div className="owl-item">
                        <div className="trends_item">
                          <div className="trends_image d-flex flex-column align-items-center justify-content-center"><img src={require("../../../../stylesheets/images/trends_2.jpg" )}alt /></div>
                          <div className="trends_content">
                            <div className="trends_category"><a href="#">Smartphones</a></div>
                            <div className="trends_info clearfix">
                      ...
                      <div className="owl-item">
                        <div className="trends_item is_new">
                          <div className="trends_image d-flex flex-column align-items-center justify-content-center"><img src={require("../../../../stylesheets/images/trends_3.jpg" )}alt /></div>
                          <div className="trends_content">
                            <div className="trends_category"><a href="#">Smartphones</a></div>
                            <div className="trends_info clearfix">
