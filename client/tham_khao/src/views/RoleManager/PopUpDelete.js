                ...
                {close => (
                    <div className="modal1">
                        ...
                        <div className="content">
                            {" "}
                            Bạn có chắc chắn muốn xóa {this.props.role.nf_grouprole} không?
                        </div>
                        <div className="actions">
                            <div className="btn btn-danger button" onClick = {() =>{this.onDelete(this.props.role.nf_id)}}>
...
const mapDispatchToProps = (dispatch, props) => {
    return {
        onDelete : (id) =>{
            dispatch(actions.delete_role(id));
        }
    }
}
